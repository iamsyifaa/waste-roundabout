...
var createWaste = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validation, _a, category_id, weight_kg, lat, long, wastePost, error_1;
        ...
        switch (_b.label) {
            case 0:
                ...
                if (!validation.success) {
                    return [2 /*return*/, res.status(400).json({ errors: validation.error.errors })];
                }
                _a = validation.data, category_id = _a.category_id, weight_kg = _a.weight_kg, lat = _a.lat, long = _a.long;
