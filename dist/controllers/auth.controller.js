...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var role, _a, name_1, email, password, hashedPassword, user, _, userWithoutPassword, error_1;
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = zod_schema_1.loginSchema.parse(req.body), email = _a.email, password = _a.password;
